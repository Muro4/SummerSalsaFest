    ...
    if (isGuest && tickets.length > 0 && !emailsSent) {
      const dispatchEmails = async () => {
        ...
        for (const t of tickets) {
          const targetEmail = t.guestEmail;
                ...
                {isGuest ? (
                  ...
                  <>
                    ...
                    <p className="font-bold text-slate-500 text-sm text-center mb-12">
                      Your passes have been permanently saved to your account.
                    </p>

                    <div className="flex flex-col sm:flex-row gap-4 mb-8">
                      <Button href="/account" variant="primary" icon={Ticket} className="shadow-salsa-pink/20 !px-10 !py-4">
                        Go to My Account
                      </Button>
