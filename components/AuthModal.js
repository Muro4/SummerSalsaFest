    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
      ...
      <div className="relative bg-white w-full max-w-lg rounded-[3.5rem] border-2 border-salsa-mint/30 shadow-2xl p-8 md:p-10 animate-in zoom-in duration-300 max-h-[90vh] overflow-y-auto custom-scrollbar">
        ...
        <div className="text-center mb-10">
            ...
            <p className="text-gray-400 text-[11px] font-black uppercase tracking-[0.2em] mt-3">Choose your checkout method</p>
        </div>
        <div className="space-y-4">
            <Link href="/login" className="flex items-center gap-6 p-6 rounded-[2rem] border-2 border-gray-50 hover:border-salsa-pink hover:bg-salsa-pink/5 transition-all group">
                ...
                <div className="text-left">
                    ...
                    <p className="text-[11px] text-gray-400 font-medium uppercase mt-1 leading-relaxed">Manage group tickets & view QR codes anytime</p>
                </div>
            </Link>
            <button onClick={onGuestContinue} className="w-full flex items-center gap-6 p-6 rounded-[2rem] border-2 border-gray-50 hover:border-salsa-mint hover:bg-salsa-mint/5 transition-all group text-left">
                ...
                <div>
                    ...
                    <p className="text-[11px] text-gray-400 font-medium uppercase mt-1 leading-relaxed">Fast checkout. Ticket sent to your email</p>
                </div>
            </button>
        </div>
      </div>
